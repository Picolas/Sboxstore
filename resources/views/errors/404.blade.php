...
<head>
    ...
    <meta name="description" content="404 - Gmodcreators">
    <meta name="author" content="Nestor">
    <meta name="robots" content="noindex, nofollow">

    <!-- Open Graph Meta -->
    <meta property="og:title" content="404 - Gmodcreators">
    <meta property="og:site_name" content="Gmodcreators">
    <meta property="og:description" content="404 - Gmod creators">
            ...
            <div class="hero-inner">
                <div class="content content-full">
                    <div class="py-30 text-center">
                        ...
                        <h1 class="h2 font-w700 mt-30 mb-10">Oops.. Vous venez de trouver une page d'erreur.</h1>
                        <h2 class="h3 font-w400 text-muted mb-50">Nous sommes désolés mais la page que vous cherchez n'a pas été trouvée.</h2>
