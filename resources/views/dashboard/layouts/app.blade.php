...
<head>
    ...
    <link rel="shortcut icon" href="{{ url("dash/{{ url("assets/media/favicons/favicon.png") }}") }}">
    <link rel="icon" type="image/png" sizes="192x192" href="{{ url("dash/{{ url("assets/media/favicons/favicon-192x192.png") }}") }}">
    <link rel="apple-touch-icon" sizes="180x180" href="{{ url("dash/{{ url("{{ url("assets/media/favicons/apple-touch-icon-180x180.png") }}") }}") }}">
    <!-- END Icons -->
    ...
    <link rel="stylesheet" id="css-main" href="{{ url("dash/assets/css/codebase.min.css") }}">
            ...
            <div class="content-header-section align-parent">
                ...
                <div class="content-header-item">
                    <a class="img-link mr-5" href="be_pages_generic_profile.html">
                        <img class="img-avatar img-avatar32" src="{{ url("dash/assets/media/avatars/avatar15.jpg") }}" alt="">
                    </a>
                    <a class="align-middle link-effect text-primary-dark font-w600" href="be_pages_generic_profile.html">{{ $user->name }}</a>
                </div>
                <!-- END User Info -->
            </div>
        </div>
                    ...
                    <ul class="nav-users push">
                        <li>
                            <a href="be_pages_generic_profile.html">
                                <img class="img-avatar" src="{{ url("dash/assets/media/avatars/avatar3.jpg") }}" alt="">
                        ...
                        <li>
                            <a href="be_pages_generic_profile.html">
                                <img class="img-avatar" src="{{ url("dash/assets/media/avatars/avatar14.jpg") }}" alt="">
                        ...
                        <li>
                            <a href="be_pages_generic_profile.html">
                                <img class="img-avatar" src="{{ url("dash/assets/media/avatars/avatar6.jpg") }}" alt="">
                ...
                <div class="sidebar-mini-hidden-b text-center">
                    ...
                    <ul class="list-inline mt-10">
                        <li class="list-inline-item">
                            <a class="link-effect text-dual-primary-dark font-size-xs font-w600 text-uppercase" href="be_pages_generic_profile.html">{{ $user->name }}</a>
                        </li>
                        <li class="list-inline-item">
                            <!-- Layout API, functionality initialized in Template._uiApiLayout() -->
                ...
                <div class="btn-group" role="group">
                    ...
                    <div class="dropdown-menu min-width-300" aria-labelledby="page-header-options-dropdown">
                        ...
                        <div class="row no-gutters text-center mb-5">
                            ...
                            <div class="col-2 mb-5">
                                <a class="text-elegance" data-toggle="theme" data-theme="{{ url("dash/assets/css/themes/elegance.min.css") }}" href="javascript:void(0)">
                                    <i class="fa fa-2x fa-circle"></i>
                                </a>
                            </div>
                            <div class="col-2 mb-5">
                                <a class="text-pulse" data-toggle="theme" data-theme="{{ url("dash/assets/css/themes/pulse.min.css") }}" href="javascript:void(0)">
                                    <i class="fa fa-2x fa-circle"></i>
                                </a>
                            </div>
                            <div class="col-2 mb-5">
                                <a class="text-flat" data-toggle="theme" data-theme="{{ url("dash/assets/css/themes/flat.min.css") }}" href="javascript:void(0)">
                                    <i class="fa fa-2x fa-circle"></i>
                                </a>
                            </div>
                            <div class="col-2 mb-5">
                                <a class="text-corporate" data-toggle="theme" data-theme="{{ url("dash/assets/css/themes/corporate.min.css") }}" href="javascript:void(0)">
                                    <i class="fa fa-2x fa-circle"></i>
                                </a>
                            </div>
                            <div class="col-2 mb-5">
                                <a class="text-earth" data-toggle="theme" data-theme="{{ url("dash/assets/css/themes/earth.min.css") }}" href="javascript:void(0)">
                                    <i class="fa fa-2x fa-circle"></i>
                                </a>
                            </div>
                        </div>
...
-->
<script src="{{ url("dash/assets/js/codebase.core.min.js") }}"></script>
...
-->
<script src="{{ url("dash/assets/js/codebase.app.min.js") }}"></script>
